...
raw_top='/well/papiez/users/kqe223/DEEP-PSMA_CHALLENGE_DATA/New/early_fusion/DEEP-PSMA_CHALLENGE_DATA/CHALLENGE_DATA'
data_top='/well/papiez/users/kqe223/DEEP-PSMA_CHALLENGE_DATA/New/data4'  # This is the directory where the data will be copied to
###############################################
# LM: 23-04-2025
###############################################
